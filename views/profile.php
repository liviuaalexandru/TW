...
<a href="javascript:resetpassword('show');" class="button button-reset-password">Reset password</a>
...
<div class="container">
    ...
    <ul>
        ...
        <li class="text-warning">Public Profile: <a href="<?php echo $public_url; ?>" target="_blank">HTML Url</a></li>
        <li class="text-warning">Public Profile(JSON): <a href="<?php echo $json_url; ?>" target="_blank">JSON Url</a></li>
    </ul>
...
<div id="popupbox-resetpassword">
    <form action="/user/change-password" method="post" class="text-center">
        <a href="javascript:resetpassword('hide');" class="closeButton">X</a>
        <p>
